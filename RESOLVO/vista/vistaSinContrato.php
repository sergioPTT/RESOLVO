...
<body class="flex flex-col min-h-screen">
    ...
    <div class="p-8 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-20 bg-gray-900 text-white">
      <form id="formularioSinContrato">
        ...
        <div class="flex justify-end space-x-4 mt-8">
          ...
          <input type="hidden" name="pagoSinContrato" value="pagoIlimitado">
          <input type="hidden" name="asunto" value="Sin Contrato">
          <input type="hidden" name="mensaje" value="Enorabuenas acabas de obtener el Sin Contrato">
          <input type="submit" value="Comprar" id="botonPagarSinContrato"
  ...
  <script type="text/javascript" src="./assets/js/contrato/sinContrato.js"></script>
