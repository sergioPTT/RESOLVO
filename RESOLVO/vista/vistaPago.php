    ...
    <div class="p-8 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-20 bg-gray-900 text-white">
      ...
      <form id="formularioContrato">
        <div>
          ...
          <input type="text" placeholder="correo" name="emailCliente" id="emailCliente"
        ...
        <?php
        $emailDelCliente = $_SESSION["emailCliente"]
          ?>

        <div class="flex justify-end space-x-4 mt-8">

          <!-- <input type="hidden" name="emailCliente" value="<?php echo $emailDelCliente; ?>"> -->
          <input type="hidden" name="asunto" value="Contrato Limitado">
          <input type="hidden" name="mensaje" value="Enorabuenas acabas de obtener el contrato limitado">
          <input type="hidden" name="pagoLimitado" value="pagoLimitado">
          <input type="submit" value="Comprar" id="botonPagar"
