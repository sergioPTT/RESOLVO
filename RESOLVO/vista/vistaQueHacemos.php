...
<pre>
  ...
  <div class="p-8 rounded-lg shadow-lg w-full max-w-lg mx-auto mt-20 bg-gray-900 text-white">
      ...
      <div class="flex justify-end space-x-4 mt-8">
        <button class="bg-purple-700 text-white px-4 py-2 rounded hover:bg-purple-800">Purchase</button>
        <button class="bg-purple-700 text-white px-4 py-2 rounded hover:bg-purple-800">Back to Cart</button>
      </div>
    </div>
  </main> -->
