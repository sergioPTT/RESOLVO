...
<body class="bg-blue-100 flex flex-col min-h-screen">
  ...
  <div class="flex-grow flex items-center justify-center" style="MARGIN-TOP: 6%">
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
      ...
      <form method="POST" id="formularioSinContrato" class="space-y-4">
        <div>
        ...
        <input type="hidden" name="sinContratoLimitado" value="sinContratoLimitado">
        ...
        <input type="submit" value="Enviar" id="botonSinContrato">
        </div>
      </form>
    </div>
  </div>
  ...
  <script type="text/javascript" src="./assets/js/contrato/formularioSinContrato.js"></script>
</body>
</html>
